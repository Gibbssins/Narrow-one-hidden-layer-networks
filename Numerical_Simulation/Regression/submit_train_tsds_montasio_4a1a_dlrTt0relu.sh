...
alpha_values=(4.3) #(2.23 2.43 2.453 3.55 4.4 0.7) #(1.25 1.75) # 3.5 4.5 4.75)   #(0.01 0.1 0.5 0.8 1.0 1.5 2.0 3.0 4.0 5.0) (20.0 18.0 16.0 14.0 12.0 10.0 8.0 6.0) (5.0 4.0 3.0 2.5 2.0 1.5 1.0 0.8 0.5 0.1 0.01)
#alpha_values2=(2.5) #(8.0 6.0 5.0 4.0 3.0 2.5 2.0) #(5.0 4.0 3.0 2.5 2.0 1.5 1.0 0.8 0.5 0.1 0.01)
wise_initialization="False"
LOG_FILE="./all_logfile/testttscript_output_teacher_student$teacher_student nonlinearity$nonlinearity bias_trick$bias_trick wise_initialization$wise_initialization N$N K$K K_teacher$K_teacher T$T gamma$gamma.log"
